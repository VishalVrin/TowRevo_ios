...
//    var com = "company@gmail.com"
    ...
    func SetUI()
    {
        if (APP_DEL.currentUser?.user_type == UserType.User.rawValue){
                 ...
                 arrMenuData = [APP_LBL.change_password, APP_LBL.my_inquiries,APP_LBL.about_us_small,APP_LBL.terms_conditions,APP_LBL.privacy_policy,APP_LBL.contact_us,APP_LBL.faq]
                 lblname.text = APP_DEL.currentUser!.first_name! + " " + APP_DEL.currentUser!.last_name!
                  ...
                  arrMenuData.removeAll()
                 arrMenuData = [APP_LBL.change_password,APP_LBL.inquiry_management,APP_LBL.about_us_small,APP_LBL.terms_conditions,APP_LBL.privacy_policy,APP_LBL.contact_us,APP_LBL.faq]
